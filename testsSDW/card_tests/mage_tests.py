...
from testsSDW.agents.testing_agents import CardTestingAgent, OneCardPlayingAgent, EnemySpellTestingAgent, \
    MinionAttackingAgent, PlayAndAttackAgent
from testsSDW.testing_utils import generate_game_for, StackedDeck
...
class TestMage(unittest.TestCase):
    ...
    def test_ArcaneMissilesWithSpellPower(self):
        game = playback(Replay("testsSDW/replays/card_tests/ArcaneMissilesWithSpellDamage.hsreplay"))
        game.start()
