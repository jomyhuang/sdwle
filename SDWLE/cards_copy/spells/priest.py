import copy
from SDWLE.cards.base import SpellCard, MinionCard
from SDWLE.cards.minions.priest import ShadowOfNothing
from SDWLE.cards.minions.neutral import Lightwarden
from SDWLE.tags.base import BuffUntil, Buff
from SDWLE.tags.event import TurnEnded
from SDWLE.tags.status import Stolen, SpellDamage
...
class Shadowform(SpellCard):
    ...
    def use(self, player, game):
        ...
        if type(player.hero.power) is not SDWLE.powers.MindShatter and type(
                player.hero.power) is not SDWLE.powers.MindSpike:
            player.hero.power = SDWLE.powers.MindSpike()
            player.hero.power.hero = player.hero
        elif type(player.hero.power) is SDWLE.powers.MindSpike:
            player.hero.power = SDWLE.powers.MindShatter()
            player.hero.power.hero = player.hero
