...
from SDWLE.tags.action import AddCard, Give, GiveAura, Damage
from SDWLE.tags.base import Effect, Aura, Battlecry, AuraUntil, ActionTag
from SDWLE.tags.condition import HasSecret, GreaterThan, IsType, Adjacent, IsSecret, IsSpell
from SDWLE.tags.event import SpellCast, DidDamage, TurnEnded, CardPlayed, Drawn, CardUsed
from SDWLE.tags.selector import SelfSelector, PlayerSelector, TargetSelector, \
    CharacterSelector, EnemyPlayer, RandomPicker, MinionSelector, Count, BothPlayer, CardSelector
from SDWLE.tags.status import ChangeAttack, ChangeHealth, Frozen, NoSpellTarget, ManaChange
...
class ArchmageAntonidas(MinionCard):
    ...
    def create_minion(self, player):
        return Minion(5, 7, effects=[Effect(SpellCast(), ActionTag(AddCard(SDWLE.cards.Fireball()),
                                                                   PlayerSelector()))])
