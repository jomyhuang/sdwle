...
from SDWLE.tags.action import Draw, Damage, Give, Heal, ChangeTarget, AddCard
from SDWLE.tags.base import Aura, Effect, Battlecry, ActionTag, Buff
from SDWLE.tags.card_source import CollectionSource
from SDWLE.tags.condition import Adjacent, HasOverload, IsType, OneIn, NotCurrentTarget, \
    OpponentMinionCountIsGreaterThan, And
from SDWLE.tags.event import TurnEnded, CardPlayed, MinionDied, Attack
from SDWLE.tags.selector import MinionSelector, PlayerSelector, HeroSelector, CharacterSelector, BothPlayer, \
...
from SDWLE.tags.status import ChangeAttack, ChangeHealth, Windfury
