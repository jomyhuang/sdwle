...
from SDWLE.cards.spells.warrior import BurrowingMine
from SDWLE.game_objects import Weapon, Minion
from SDWLE.tags.action import IncreaseArmor, Damage, Give, Equip, AddCard
from SDWLE.tags.base import Effect, Battlecry, Buff, Aura, ActionTag
from SDWLE.tags.condition import AttackLessThanOrEqualTo, IsMinion, IsType, GreaterThan
from SDWLE.tags.event import MinionPlaced, CharacterDamaged, ArmorIncreased, Damaged
from SDWLE.tags.selector import BothPlayer, SelfSelector, TargetSelector, HeroSelector, MinionSelector, \
...
from SDWLE.tags.status import ChangeAttack, Charge, ChangeHealth
