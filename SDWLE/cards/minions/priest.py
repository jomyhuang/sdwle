...
from SDWLE.tags.action import Heal, Draw, Steal, Give, Damage, SwapStats
from SDWLE.tags.base import Aura, Deathrattle, Effect, Battlecry, Buff, BuffUntil, ActionTag
from SDWLE.tags.condition import IsMinion, AttackLessThanOrEqualTo, IsType, IsDamaged, GreaterThan
from SDWLE.tags.event import TurnStarted, CharacterHealed, TurnEnded
from SDWLE.tags.selector import PlayerSelector, MinionSelector, CharacterSelector, BothPlayer, \
...
from SDWLE.tags.status import ChangeHealth, HealAsDamage, AttackEqualsHealth, MultiplySpellDamage, \
