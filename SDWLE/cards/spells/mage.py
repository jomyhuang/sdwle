...
from SDWLE.tags.condition import IsMinion
from SDWLE.tags.event import TurnEnded
from SDWLE.tags.selector import CurrentPlayer, Count, DeadMinionSelector, BothPlayer
from SDWLE.tags.status import Immune, Frozen, ManaChange
...
class Polymorph(SpellCard):
    ...
    def use(self, player, game):
        super().use(player, game)
        from SDWLE.cards.minions.mage import Sheep
        sheep = Sheep()
