...
from SDWLE.tags.action import Kill, Damage
from SDWLE.tags.base import Effect, ActionTag
from SDWLE.tags.card_source import CollectionSource
from SDWLE.tags.condition import IsType, MinionIsTarget
from SDWLE.tags.event import TurnStarted, TurnEnded, CardDiscarded
from SDWLE.tags.selector import SelfSelector, EnemyPlayer, CharacterSelector, RandomPicker
import SDWLE.targeting
from SDWLE.constants import CHARACTER_CLASS, CARD_RARITY, MINION_TYPE
from SDWLE.cards.minions.warlock import Imp
    ...
    def use(self, player, game):
        ...
        for i in range(0, 2):
            ...
            if demon_card:
                ...
                if len(player.hand) < 10:
                    player.hand.append(SDWLE.cards.minions.warlock.WorthlessImp())
                    player.hand[-1].player = player
                    self.trigger("card_drawn", SDWLE.cards.minions.warlock.WorthlessImp())
