...
class RoguePower(Power):
    def use(self):
        super().use()
        from SDWLE.cards.weapons.rogue import WickedKnife
...
class ShamanPower(Power):
    ...
    def use(self):
        super().use()
        from SDWLE.cards.minions.shaman import HealingTotem, SearingTotem, StoneclawTotem, WrathOfAirTotem
...
class JaraxxusPower(Power):
    def use(self):
        super().use()
        from SDWLE.cards.minions.warlock import Infernal
