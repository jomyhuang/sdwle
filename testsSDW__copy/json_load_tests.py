import json
import re
from SDWLE.cards.base import MinionCard, WeaponCard
from SDWLE.game_objects import Weapon, Minion
import testsSDW.card_tests.druid_tests
import testsSDW.card_tests.mage_tests
import testsSDW.card_tests.hunter_tests
import testsSDW.card_tests.paladin_tests
import testsSDW.card_tests.priest_tests
import testsSDW.card_tests.rogue_tests
import testsSDW.card_tests.shaman_tests
import testsSDW.card_tests.warlock_tests
import testsSDW.card_tests.warrior_tests
import testsSDW.card_tests.neutral_tests
...
class JSONTester:
    def define_type(self, card_def):
        from SDWLE.constants import CHARACTER_CLASS, MINION_TYPE, CARD_RARITY
        from SDWLE.tags.base import Battlecry, Choice, Deathrattle, Effect, Aura, Buff
        import SDWLE.cards
        ...
        if card_def['rarity'] != "Special":
            ...
            cls_def = getattr(SDWLE.cards, name, None)
            if cls_def:
    ...
    def tearDown(self):
        ...
        for name, defn in self.old_attrs.items():
            cls_def = getattr(SDWLE.cards, name)
...
class TestJSONDruid(JSONTester, testsSDW.card_tests.druid_tests.TestDruid):
    pass


class TestJSONMage(JSONTester, testsSDW.card_tests.mage_tests.TestMage):
    pass


class TestJSONHunter(JSONTester, testsSDW.card_tests.hunter_tests.TestHunter):
    pass


class TestJSONPaladin(JSONTester, testsSDW.card_tests.paladin_tests.TestPaladin):
    pass


class TestJSONPriest(JSONTester, testsSDW.card_tests.priest_tests.TestPriest):
    pass


class TestJSONRogue(JSONTester, testsSDW.card_tests.rogue_tests.TestRogue):
    pass


class TestJSONShaman(JSONTester, testsSDW.card_tests.shaman_tests.TestShaman):
    pass


class TestJSONWarlock(JSONTester, testsSDW.card_tests.warlock_tests.TestWarlock):
    pass


class TestJSONWarrior(JSONTester, testsSDW.card_tests.warrior_tests.TestWarrior):
    pass


class TestJSONNeutral(JSONTester, testsSDW.card_tests.neutral_tests.TestCommon):
    pass
