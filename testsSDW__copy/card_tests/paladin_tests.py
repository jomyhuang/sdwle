...
from testsSDW.agents.testing_agents import OneCardPlayingAgent, CardTestingAgent, EnemyMinionSpellTestingAgent, \
    PlayAndAttackAgent
...
class TestPaladin(unittest.TestCase):
    ...
    def test_BlessingOfWisdom(self):
        game = playback(Replay("testsSDW/replays/card_tests/BlessingOfWisdom.hsreplay"))
        game.start()
    ...
    def test_NobleSacrifice(self):
        ...
        # Test with 7 minions
        game = playback(Replay("testsSDW/replays/card_tests/NobleSacrifice.hsreplay"))
        game.start()
